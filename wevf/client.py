...
from PySide2.QtCore import QUrl, QSize, Slot, QSocketNotifier, QPointF, QPoint
from PySide2.QtGui import QSurfaceFormat, QOpenGLContext, QOffscreenSurface, QMouseEvent, Qt, QWheelEvent, QCursor, \
    QKeyEvent
from pywayland.client import Display
from pywayland.utils import AnonymousFile

from wevf.events import MOUSE_EVENTS, MOUSE_BUTTONS, WHEEL_ANGLES, EventType, deserialize_modifiers, KEY_EVENTS, \
    get_qt_key
